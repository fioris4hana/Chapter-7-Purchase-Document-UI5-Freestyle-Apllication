		...
		onTheCreatePurchaseDocumentPage: {
			...
			actions: {
				iEnterPurchaseDocumentData: function (oPurchaseDocument) {
					// Enter Purchase Document Id
					this.waitFor({
						viewName: sCreatePurchaseDocumentView,
						id: "purchaseDocumentSmartField",
						actions: new EnterText({
							text: oPurchaseDocument.PurchaseDocument
						})
					});
						...
						success: function (oComboBox) {
							this.waitFor({
								...
								matchers: [
									...
									new Properties({
										key: oPurchaseDocument.Priority
									})
								],
								actions: new Press(),
								errorMessage: "Cannot select Priority High"
							});
						},
